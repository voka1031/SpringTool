...
import com.voka.handler.*;

@Configuration
@EnableWebMvc
@EnableAspectJAutoProxy
@ComponentScan(basePackages = "com.voka")
public class WebConfig extends WebMvcConfigurerAdapter {
	...
	public ViewResolver internalViewResolver() {
		...
		resolver.setPrefix("/WEB-INF/views/practice/");
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(new PracticeInterceptor()).addPathPatterns("/practice/**");
