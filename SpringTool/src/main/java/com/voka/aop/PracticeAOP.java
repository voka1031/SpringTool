...
public class PracticeAOP {
	...
	// 所有繼承這個interface的方法.
	// @Pointcut("target(com.voka.model.PracticeDAO_interface)")

	// @Pointcut("execution(* com.voka.model.PracticeDAO_interface.get*(..))"
	// + " && !execution(* com.voka.model.PracticeDAO_interface.getPaging(..))")
	@Pointcut("@annotation(com.voka.annotation.CatchForAOP)")
