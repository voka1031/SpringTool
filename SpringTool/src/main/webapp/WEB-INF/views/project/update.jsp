	...
	<form:form action="update" method="POST" modelAttribute="customer">
		...
		<table>
			<tr>
				...
				<td>
					<form:input type="text" path="id" id="id" size="25" value="${customer.id}" cssStyle="border:0px ; font-weight: bold;" />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<form:input type="text" path="name" id="name" size="25" value="${customer.name}" />
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<form:input type="text" path="tel" id="tel" size="25" value="${customer.tel}" />
				<td>
		...
		<br>
		<button class="btn btn-primary" type="submit" onClick="return check()">送出修改</button>
		<input class="btn btn-primary" type="submit" value="送出修改" onClick="return check()">
	</form:form>
</div>
